...
window.onload = async function getSearch_api(){
    ...
    if (User_payload === undefined ||  User_payload === null){
        ...
        // 인기 게시글
        best_feed_list = await getSearch(search_word)
            ...
            best_feed.tags.forEach(tag => {
                ...
                <div class="new_feed_box vertical_alignment">
                    <div class="nf_image_box">
                        <img class="nf_image" src="${best_feed.image}" onclick="location.href='${frontEndBaseUrl}/communities/detail.html?id=${best_feed.id}'"/>
                    </div>
            ...
            feed.tags.forEach(tag => {
                ...
                <div class="sub_feed_box vertical_alignment">
                    <div class="sub_feed_image_box">
                        <img class="feed_image" src="${feed.image}"/>
                    </div>
